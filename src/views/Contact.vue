    ...
    <div class="max-w-6xl mx-auto relative z-10">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div data-aos="fade-right">
          ...
          <div class="space-y-6 mb-8">
            ...
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="https://github.com/santa36264" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-400 hover:underline font-medium">
            ...
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="https://www.linkedin.com/in/semre-demssie-9728b73a8/" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-400 hover:underline font-medium">
          ...
          <!-- Quick Links -->
          <div class="bg-blue-600 dark:bg-blue-700 rounded-2xl p-8 text-white">
            <h3 class="text-xl font-bold mb-4">Quick Links</h3>
            <div class="space-y-3">
              <router-link to="/portfolio" class="block hover:translate-x-2 transition-transform">
                → View My Portfolio
              </router-link>
              <router-link to="/services" class="block hover:translate-x-2 transition-transform">
                → Services I Offer
              </router-link>
              <router-link to="/blog" class="block hover:translate-x-2 transition-transform">
                → Read My Blog
              </router-link>
            </div>
          </div>
        ...
        <div data-aos="fade-left">
          <form @submit.prevent="handleSubmit" class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
            <h2 class="text-2xl font-bold mb-6 text-gray-900 dark:text-white">
              Send Me a Message
            </h2>
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="6"
                  class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none"
